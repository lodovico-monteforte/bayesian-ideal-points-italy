...
01_scraping_19.py
-----------------
Scrapes final roll-call votes from the Italian Chamber of Deputies (XIX Legislature, 2022-present)
via the SPARQL endpoint at dati.camera.it.

Output: dataset_replica_XIX.csv (one row per legislator per vote)

Usage: python 01_scraping_19.py
...
file_output  = "dataset_replica_XIX.csv"
...
# ------------ STEP 1: RETRIEVE LIST OF FINAL VOTES
...
# ------------ STEP 3: DOWNLOAD VOTE-LEVEL DATA
